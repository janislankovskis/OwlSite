...
<form onsubmit="ExampleDialog.insert();return false;" action="#">	
	<?php 
		...
		if(isset($out))
		{
			...
			$string = '<img src="' . $out . '" ALT="" />'; 
		}
	
	?>
	<input id="someval2" name="someval2" type="hidden" value='<?php echo $string; ?>' class="text" />
	<!-- <input id="someval" name="someval" type="textarea" value='' class="text" /> -->
	<input id="somearg" name="somearg" type="hidden" class="text" />
	<div style="clear:both;"></div>	
	<div class="mceActionPanel">
		<input type="button" id="insert" name="insert" value="Ok" onclick="ExampleDialog.insert();" />
...
?>		
		...
		<br />
		<button type="submit" onclick="ExampleDialog.insert();">Insert</button>
